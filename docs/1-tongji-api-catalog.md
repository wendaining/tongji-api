...
```
POST /api/cultureservice/bclCulturePlan/findStudentPlanList     # 学生培养方案
POST /api/cultureservice/bclCultureScheme/findCultureSchemeList # 培养方案列表
POST /api/cultureservice/bclCourses/page                        # 课程库
POST /api/cultureservice/courses/page                           # 课程管理
POST /api/cultureservice/coursesLabel/coursesLabelList          # 课程标签
POST /api/cultureservice/studentCultureRel/courses              # 学生课程关联
```
